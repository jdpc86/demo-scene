...
* Git
* https://jdk.dev[Java 11 (or later)], preferably 11, might run into gradle dependency issues with higher JDK.
...
update skaffold.yaml image approriate to your environment, for example:
image: localhost:5000/movies-generator
----
skaffold run #<1>
skaffold delete #<2>
----
<1> This command will build images for
<2> This command will delete kubernetes resources deployed by step 1
